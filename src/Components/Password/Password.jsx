...
const Password = () => {
  const handleSubmit = (e) => {
    ...
    // Replace the following line with your actual password reset implementation
  ...
  return (
    <section className="bg-gray-50 dark:bg-gray-900">
      <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <img className="w-20 h-8 mr-2" src={logo} alt="logo" />
        <h1 className='flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white'>InnobotHeath</h1>
